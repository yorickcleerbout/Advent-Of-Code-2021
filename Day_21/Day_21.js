...
console.log("what do you get if you multiply the score of the losing player by the number of times the die was rolled during the game?", part_one(input));
console.log("Find the player that wins in more universes; in how many universes does that player win?", part_two(input));