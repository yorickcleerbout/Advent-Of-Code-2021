...
function part_one() {
    ...
    return countLight(doubleConvolution({ image, algorithm }));
}
...
function part_two() {
    return countLight(multipleConvolution({ image, algorithm, steps: 50, }));
}


console.log("How many pixels are lit in the resulting image?", part_one());
console.log("How many pixels are lit in the resulting image?", part_two());
