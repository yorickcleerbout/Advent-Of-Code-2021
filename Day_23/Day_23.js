...
console.log("What is the least energy required to organize the amphipods?", part_one())
console.log("What is the least energy required to organize the amphipods?", part_two())