...
console.log("What will your final score be if you choose that board?", part_one());
console.log("Once it wins, what would its final score be?", part_two());